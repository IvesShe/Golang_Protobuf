...
func (x *BytesMessage) GetHeader() *Header {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *BytesMessage) GetBody() []byte {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *StringMessage) GetHeader() *Header {
	if x != nil {
		return x.Header
	}
	return nil
...
var file_packet_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x22, 0x3c, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72,
	0x12, 0x1c, 0x0a, 0x09, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x64, 0x18, 0x01, 0x20,
	0x02, 0x28, 0x09, 0x52, 0x09, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x64, 0x12, 0x14,
	0x0a, 0x05, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x18, 0x02, 0x20, 0x02, 0x28, 0x09, 0x52, 0x05, 0x74,
	0x6f, 0x70, 0x69, 0x63, 0x22, 0x4a, 0x0a, 0x0c, 0x42, 0x79, 0x74, 0x65, 0x73, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x12, 0x26, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x02, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x48, 0x65,
	...
	0x22, 0x4b, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x12, 0x26, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x02, 0x28,
	0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x6f, 0x64,
	0x79, 0x18, 0x02, 0x20, 0x02, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79,
}
...
var file_packet_proto_goTypes = []interface{}{
	...
	(*BytesMessage)(nil),  // 1: packet.BytesMessage
	(*StringMessage)(nil), // 2: packet.StringMessage
}
var file_packet_proto_depIdxs = []int32{
	0, // 0: packet.BytesMessage.header:type_name -> packet.Header
	0, // 1: packet.StringMessage.header:type_name -> packet.Header
